...
(*design for quick save mode: exptid of a PDFset is defined by input exptidlist*)
printprocessbyPDFsetquicksavemode[exptidlistin_,datalistFilein_]:=
Module[{exptidlist=exptidlistin,datalistFile=datalistFilein,processes,ExptList1,pdfsetexps,processestitle,PDISNCtitle,NDISCCtitle,PDISNCCCtitle,PVBPZtitle,PVBPWtitle,PJPtitle,hDISNCtitle,hDISCCtitle,hVBPZtitle},
(*set processes title, expid*)
processes={PDISNC,NDISCC,PDISNCCC,PVBPZ,PVBPW,PJP,hDISNC,hDISCC,hVBPZ};
...
(*get information of experiments in the PDFset we choose*)
(*pdfsetexps=Table[CT14NNLOcorr[[i,1]][["exptinfo","exptid"]],{i,1,Length[ExptList1]}];*)
pdfsetexps=exptidlist;
