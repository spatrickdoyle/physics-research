...
(* ::Input::Initialization:: *)
readcorrconfigfile3[configDirin_,configfilenamein_]:=
Module[{configDir=configDirin,configfilename=configfilenamein,
...
XQfigureXrangeTag,XQfigureYrangeTag,Hist1figureNbinTag,Hist1figureXrangeTag,Hist1figureYrangeTag,
...
FigureType=ReadList[StringToStream[FigureType],Number];
...
itag=itag+1;
If[output3[[itag,1]]==Hist1figureNbinTag,Hist1figureNbin=output3[[itag,2]] ];
...
*)
{(*Jobid*)dummy1,PDFname,(*FigureType*)dummy2,(*FigureFlag*)dummy3,ExptidType,ExptidFlag,(*CorrelationArgType*)dummy4,(*CorrelationArgFlag*)dummy5,(*UserArgName*)dummy6,(*UserArgValue*)dummy7,
(*XQfigureXrange*)dummy8,(*XQfigureYrange*)dummy9,(*Hist1figureNbin*)dummy10,(*Hist1figureXrange*)dummy11,(*Hist1figureYrange*)dummy12}=
readcorrconfigfile3[configDir,configfilename];
Print[readcorrconfigfile3[configDir,configfilename] ];
...
Print["error, the correlation data of PDFname ",PDFname,"does not exist in quick database"];Exit[]
];
...
(*it flag is on, add that exptid into exptlist*)
Table[
...
(*set expeiments*)
(*exptlist={514,101};*)
(*20170301: new config file, quick mode does not need it
exptlist=
Switch[
expttype,
"All",exptlistAll,
...
(*for quick read mode, don't need pdfsetdir for PDFname, just input a dummy*)
processdataplotsmultiexp2[corrfxQdtaobsclassfinal,dRcorrfxQdtaobsclassfinal,deltaRclassfinal,(*pdfdatain_,*)(*myPDFsetDir<>"whatever"*)"dummy",(*PDFDataDirin_,CorrDataDirin_,*)datalistFile,procs,expids,flavour,SMmode,expttype],
{SMmode,1,3},{flavour,-5,-5+fmax-1}];
...
TimeMakefigi=SessionTime[];

Print["save plots into directory:\n",saveparentpath<>pdfnameexpttypeDir<>exptidDir];
...
TimeMakefigf=SessionTime[];

(*TimeMakefig=TimeMakefigf-TimeMakefigi;*)
Print["total time to make plot is ",TimeMakefigf," seconds"];
(*manipulate*)
