...
exptnamestable=makeGrid[exptnames,rows];
...
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>filename,p6,ImageResolution->imgresol ];
];
...
p5[[1]]=Append[p5[[1]],exptnamestable];
filename=obsname[[5]]<>"_"<>representationname[[1]]<>"_"<>"f"<>ToString[flavour]<>extensionname[[iext]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>filename,p5,ImageResolution->imgresol  ];
...
p2[[1]]=Append[p2[[1]],exptnamestable];
filename=obsname[[2]]<>"_"<>representationname[[1]]<>extensionname[[iext]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>filename,p2,ImageResolution->imgresol ];
];
...
p3[[1]]=Append[p3[[1]],exptnamestable];
filename=obsname[[3]]<>"_"<>representationname[[1]]<>extensionname[[iext]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>filename,p3,ImageResolution->imgresol ];
];
...
p4[[1]]=Append[p4[[1]],exptnamestable];
filename=obsname[[4]]<>"_"<>representationname[[1]]<>extensionname[[iext]];
Export[saveparentpath<>(*pdfnameexpttypeDir<>exptidDir*)jobpath<>filename,p4,ImageResolution->imgresol  ];
];
