...
def getJobID(exp_boxes,fig_boxes,func_boxes,auto_boxes,pdfset,sizes,vmins,vmaxs,pmins,pmaxs,user_func,bounds,selects,expids):
...
def makeGraph(jobID):
    ...
    os.system("/usr/local/bin/math -script "+AMATH+"correlation_plot_project_v"+VERSION+"_script.m 
&")
